---
permalink: sample-site/reference_site_survey_and_planning_worksheet_destination_storage_devices_tab.html 
sidebar: sidebar 
...
---
= ONTAP FLI Site Survey and Planning worksheet Destination Storage Devices 选项卡
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
